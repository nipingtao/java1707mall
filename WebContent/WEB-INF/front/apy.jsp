...
<head>
	...
	function a(id){
	 location.href="${ctx}/order/deletById.shtml?id="+id;
	}
	</script>
					...
					<div class="member-cancel clearfix">
						...
						<span class="be2">订单操作</span>
									...
									<div class="member-minute clearfix">
										...
										<div class="ci3"><b>${orderItem.totalPrice}</b>
										</c:forEach>
										...
										<div class="ci5 ci8"><p><a onclick="moreAc(${order.orderNo})">详细信息</a></p><p><a href="#" class="member-touch">提醒发货</a> </p> <p><a onclick="a(${order.id})">取消订单</a> </p></div>
									</div>
