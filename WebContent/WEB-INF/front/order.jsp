...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/resources/front/css/base2.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/resources/front/css/home2.css">
				...
				<form  id="checkoutForm" action="#" method="post">
								...
								<div class="clearfix xm-address-list" id="checkoutAddrList">
									<dl class="item" >
										<dt>
											...
											<span class="itemTag tag">${shipping.receiverCity}</span>
										</dt>
										<dd>
											<p class="tel itemTel">${shipping.receiverPhone}</p>
											<p class="itemRegion">${shipping.receiverProvince}${shipping.receiverCity}</p>
											<p class="itemStreet">${shipping.receiverCity}${shipping.receiverDistrict}${shipping.receiverAddress}</p>
					...
					<div class="checkout-box-ft">
									...
									<dl class="checkout-goods-list">
										...
										<dd class="item clearfix">
											<div class="item-row">
												<div class="col col-1">
													<div class="g-pic">
														<img src="/pic/${cartItemVO.product.mainImage}" width="40" height="40"/>
													</div>
													<div class="g-info">
						...
						<div class="checkout-confirm">
							...
							<a href="${ctx}/cart/addCart.shtml" class="btn btn-lineDakeLight btn-back-cart">返回购物车</a>
							<a href="${ctx}/order/addOrder.shtml" class="btn btn-primary">立即下单</a>
