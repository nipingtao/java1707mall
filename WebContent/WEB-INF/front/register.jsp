...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctx}/resources/front/css/register_style.css" />
	</head>
	...
	<body>
		...
		<div class="banner">
			...
			<div class="banner_center">
				<form action="/Java1707Mall/login/add.shtml" method="post">
					<div class="register">
						<ul>
							...
							<li>
								<input class="register_user" name="username" type="text" placeholder="会员名/邮箱/手机号" />
							</li>
							<li>
							...
							<li>
								<input class="register_password" name="password" type="password" placeholder="密码" />
							</li>
							<li>
								<input class="register_repassword" type="text" placeholder="重置密码" />
							</li>
							<li>
								<input class="register_finish" type="submit" value="同意协议并注册" />
							</li>
